...
public class WorkspaceEvent {
    ...
    public final static int BLOCK_CLONED_THIS = 52;
    public final static int BLOCK_CLONED_RIGHT = 53;
    public final static int BLOCK_CLONED_ALL = 54;
    ...
    public String toString() {
        switch (eventType) {
            ...
            case BLOCK_CLONED:
            	return "WorkspaceEvent(BLOCK_CLONED)";
            case BLOCK_CLONED_THIS:
            	return "WorkspaceEvent(BLOCK_CLONED_THIS)";
            case BLOCK_CLONED_RIGHT:
            	return "WorkspaceEvent(BLOCK_CLONED_RIGHT)";
            case BLOCK_CLONED_ALL:
            	return "WorkspaceEvent(BLOCK_CLONED_ALL)";
            default:
